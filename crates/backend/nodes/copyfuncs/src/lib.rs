...
/// Wire the centralized [`copyfuncs_seams::copy_object`] seam to
...
pub fn init_seams() {
    copyfuncs_seams::copy_object::set(|dst, n| n.copy_node_in(dst));
    ...
    copyfuncs_pc_seams::list_member_oid::set(|list, oid| {
...
mod tests {
    ...
    fn install_routes_the_seam_to_this_impl() {
        ...
        let via_seam = copyfuncs_seams::copy_object::call(ctx_dst.mcx(), &original)
